  ...
  return (
    <>
      <div className='overflow-scroll fixed w-[100%] h-[100%] bg-orange-300'>
        <div className='flex justify-center py-2 w-[100%] font-serif text-6xl text-white'>
          <h1>Access</h1>
        </div>
        <div className='flex flex-col justify-center items-center text-2xl sm:text-[15px]'>
          <p>Address: 札幌市中央区南9条西20丁目3-12</p>
          <p>Phone Number: 011-533-1824</p>
        </div>
        <div className='flex justify-center p-10 pt-1 mb-32'>
          <iframe
        ...
        <div className='p-1 mx-auto space-y-1 font-serif'></div>
      </div>
    </>
  );
};
